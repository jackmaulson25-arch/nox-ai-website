    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6 grid-bg">
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-nox-400 text-sm mb-6">We sent a confirmation link to <strong className="text-white">{email}</strong></p>
          <Link href="/auth/login" className="text-nox-400 hover:text-white text-sm">Back to login</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex items-center justify-center px-6 grid-bg">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-nox-400 text-sm">Start building with Nox AI</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              ...
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} required className="w-full bg-nox-900/40 border border-nox-800/30 rounded-xl px-4 py-3 text-sm text-white placeholder:text-nox-600 focus:outline-none focus:border-nox-500" placeholder="John Doe" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} className="w-full bg-nox-900/40 border border-nox-800/30 rounded-xl px-4 py-3 text-sm text-white placeholder:text-nox-600 focus:outline-none focus:border-nox-500" placeholder="••••••••" />
            </div>
          ...
          <p className="text-center text-xs text-nox-500 mt-6">
            Already have an account? <Link href="/auth/login" className="text-nox-400 hover:text-white">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
